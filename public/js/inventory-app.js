...
Vue.component('dashboard', {
    ...
    methods: {
        ...
        fetchTypeaheadItems: function fetchTypeaheadItems() {
...
Vue.component('movement-list', {
    ...
    methods: {
        fetchMovements: function fetchMovements(page) {
...
Vue.component('movement-create', {
    ...
    methods: {
        ...
        fetchLastMovements: function fetchLastMovements() {
...
Vue.component('item-show', {
    ...
    methods: {
        ...
        loadChart: function loadChart(movement_data) {
...
$("#list-items").length > 0 ? new Vue({
    ...
    data: {
        ...
        sortKey: 'item_name',
        reverse: false,
        columns: [{ id: 'item_name', name: "Name", click: function click(a, b, c) {
                debugger;
                this.redirectToURL('/items/' + item.id);
            } }, { id: 'client_name', name: "Client" }, { id: 'item_code', name: "Code" }, { id: 'quantity', name: "Quantity" }, { id: 'minimum_level', name: "Minimum Level" }, { id: 'created_at', name: "Created" }]
    },
    ...
    methods: {
        ...
        clientNameTypeahead: function clientNameTypeahead() {
        ...
        getSelectedClient: function getSelectedClient() {
            var ta = $("#client-name-typeahead");
            var current = ta.typeahead("getActive");
        ...
        filterToSelectedClient: function filterToSelectedClient() {
            var ta = $("#client-filter-typeahead");
            var current = ta.typeahead("getActive");
        ...
        removeFilterToSelectedClient: function removeFilterToSelectedClient(e) {
            this.filtered_to_client_id = "";
            this.client_filter_input_text = "";
            this.fetchItems(0);
        },

        deleteAreYouSure: function deleteAreYouSure(e) {
        ...
        editItem: function editItem(item, e) {
            var i = item;
        }
    }
...
$("#item_movements_show").length > 0 ? new Vue({
    ...
    methods: {
        fetchMovement: function fetchMovement() {
...
var addAlert = function addAlert(message, type, delay) {
